...
@section('content')
    ...
    <div class="mt-4">
        <div class="d-flex justify-content-between mb-4">
            ...
            @include('backend.school_admin.section.partials.action')
        </div>
        <div class="card">
            <div class="card-body">
...
@section('scripts')
    <script>
        ...
        $(document).on('click', '.edit-section', function() {
            ...
            $('#dynamic_section_name').val(section_name);
            ...
            $('#sectionForm').attr('action', '{{ route('admin.sections.update', '') }}' + '/' + id);
            $('#methodField').val('PUT');
